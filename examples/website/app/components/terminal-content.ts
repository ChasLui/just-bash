...
export const FILE_AGENTS_MD = `# AGENTS.md - just-bash
...
> This example reflects the historical browser execution path and is for reference only.
> Active runtime is Rust-first in \`packages/just-bash/rust-core\` (CLI: \`just-bash-rs\`).
...
### 1. just-bash (Browser)
- In-browser execution path (historical TypeScript implementation used by this legacy example)
